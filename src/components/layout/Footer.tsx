        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products?category=home" className="text-gray-400 hover:text-white">Home & Garden</Link></li>
              <li><Link to="/products?category=sports" className="text-gray-400 hover:text-white">Sports</Link></li>
              <li><Link to="/products?category=books" className="text-gray-400 hover:text-white">Books</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">contact@ecommerce.com</span>
              </div>
            </div>
          </div>
        </div>
